...
interface ISethPairFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ISethPairFactory extends BaseContract {
  ...
  interface: ISethPairFactoryInterface;
