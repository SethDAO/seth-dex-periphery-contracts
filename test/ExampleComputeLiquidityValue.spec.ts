...
import { IERC20, ISethRouter02, ExampleComputeLiquidityValue__factory } from "../types";
...
describe("ExampleComputeLiquidityValue", () => {
    ...
    beforeEach(async function () {
        ...
        computeLiquidityValue = await new ExampleComputeLiquidityValue__factory(wallet).deploy(
        ...
        describe("fee is off", () => {
            it("produces the correct value after arbing to 1:105", async () => {
                const [token0Amount, token1Amount] =
                    await computeLiquidityValue.getLiquidityValueAfterArbitrageToPrice(
                        token0.address,
                        token1.address,
                        1,
                        105,
