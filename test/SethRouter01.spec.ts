...
import { IERC20, WETH9, ISethRouter01, RouterEventEmitter, ISethRouter02 } from "../types";
...
enum RouterVersion {
    SethRouter01 = "SethRouter01",
    SethRouter02 = "SethRouter02",
}

describe("SethRouter{01,02}", () => {
    let wallet: Wallet;
    ...
    let token1: IERC20;
    let WETH: WETH9;
    let WETHPartner: IERC20;
    let factory: SethPairFactory;
    let router: ISethRouter01 | ISethRouter02;
    let pair: SethPair;
    let WETHPair: SethPair;
    ...
    for (const routerVersion of Object.keys(RouterVersion)) {
        ...
        beforeEach(async function () {
            ...
            router = {
                [RouterVersion.SethRouter01]: fixture.router01,
                [RouterVersion.SethRouter02]: fixture.router02,
        ...
        describe(routerVersion, () => {
            ...
            it("removeLiquidityETHWithPermit", async () => {
                ...
                const pairName = await WETHPair.name();
                const chainId = CHAIN_ID;
                const digest = await getApprovalDigest(
                    pairName,
                    WETHPair.address,
            ...
            describe("swapExactTokensForTokens", () => {
                ...
                it("gas", async () => {
                    ...
                    expect(receipt.gasUsed).to.eq(
                        {
                            [RouterVersion.SethRouter01]: 102978,
                            [RouterVersion.SethRouter02]: 102990,
                        }[routerVersion as RouterVersion]
                    );
                }).retries(3);
            });
            ...
            describe("swapExactETHForTokens", () => {
                ...
                it("gas", async () => {
                    ...
                    expect(receipt.gasUsed).to.eq(
                        {
                            [RouterVersion.SethRouter01]: 109810,
                            [RouterVersion.SethRouter02]: 109822,
                        }[routerVersion as RouterVersion]
                    );
                }).retries(3);
            });
